...
date: '2025-02-02'
tags: ['Powershell', 'webrequest', 'Tools']
draft: false
summary: 'This section will cover how we interact with the web and show several ways to utilize PowerShell to serve this purpose.'
---
...
```shell-session
EvaUnit09@htb[/htb]$ python3 -m http.server 8000
